...
<body class="min-h-screen bg-gray-50">
  ...
  <script type="text/babel">
    ...
    const Droplet = ({ className }) => <span className={className}>💧</span>;
    const Sparkles = ({ className }) => <span className={className}>✨</span>;
    const Pipette = ({ className }) => <span className={className}>🧪</span>;
    const Flame = ({ className }) => <span className={className}>🔥</span>;
    const Beaker = ({ className }) => <span className={className}>⚗️</span>;
    const Pill = ({ className }) => <span className={className}>💊</span>;
    const Boxes = ({ className }) => <span className={className}>📦</span>;
    const FlaskConical = ({ className }) => <span className={className}>⚗️</span>;
    const ShoppingBasket = ({ className }) => <span className={className}>🛒</span>;
    ...
    const CosmoCheckApp = () => {
      ...
      useEffect(() => {
        const mockBrands = [
          { id: 1, name: 'The Ordinary', logo: '🧪', totalReports: 234, avgRiskScore: 32, status: 'safe', trendCount: 8 },
          { id: 2, name: 'CeraVe', logo: '💙', totalReports: 89, avgRiskScore: 15, status: 'safe', trendCount: 5 },
          { id: 3, name: 'TikTok DIY', logo: '🎥', totalReports: 567, avgRiskScore: 73, status: 'warning', trendCount: 15 },
          { id: 4, name: 'Drunk Elephant', logo: '🐘', totalReports: 156, avgRiskScore: 28, status: 'safe', trendCount: 6 },
          { id: 5, name: 'La Roche-Posay', logo: '💧', totalReports: 43, avgRiskScore: 12, status: 'safe', trendCount: 4 },
          { id: 6, name: 'Homemade Recipes', logo: '🏠', totalReports: 423, avgRiskScore: 68, status: 'warning', trendCount: 12 }
        ];
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold text-gray-900">⚠️ Active Safety Warnings</h2>
                    <button
                      onClick={() => setActiveTab('trends')}
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-red-700">
                                {trend.reports} reports • Risk Score: {trend.riskScore}
                              </p>
                            </div>
                ...
                {selectedTrend && (
                  <div className={`border-2 rounded-xl p-6 ${getRiskColor(selectedTrend.status)}`}>
                    ...
                    <div className="mt-4 text-sm opacity-75">
                      {selectedTrend.reports} community reports • Updated {selectedTrend.lastUpdated}
                    </div>
                  </div>
                )}
              </div>
                      ...
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <div>
                          ...
                          <p className="text-xs opacity-75">
                            {trend.brandName} • {trend.reports} reports • {trend.lastUpdated}
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-80">
                          {selectedBrand.trendCount} tracked trends • {selectedBrand.totalReports}{' '}
                          community reports
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3 flex-1">
                            ...
                            <div>
                              <h3 className="font-semibold">{trend.name}</h3>
                              <p className="text-xs opacity-75">
                                {trend.reports} reports • {trend.lastUpdated}
                              </p>
                            </div>
                          </div>
                          <div className="text-right">
...
file_path = "/mnt/data/cosmo-check.html"
